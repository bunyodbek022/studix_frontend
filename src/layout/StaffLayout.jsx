  ...
  return (
    <div className="min-h-screen bg-[#f6f7fb] text-slate-900">
      <div className="flex min-h-screen">
        ...
        <aside
          className={`fixed left-0 top-0 z-40 flex h-screen w-64 transform flex-col border-r border-slate-200 bg-white px-4 py-5 transition-transform duration-300 lg:static lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
            }`}
        >
          ...
          <div className="mt-auto pt-8">
            <button onClick={handleLogout} className="flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium text-rose-600 transition hover:bg-rose-50">
        ...
        <main className="flex-1">
          <div className="px-4 py-4 sm:px-5 lg:px-6">
            <header className="mb-6 rounded-3xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
