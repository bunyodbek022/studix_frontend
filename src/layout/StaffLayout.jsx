    ...
    return (
        <div className="min-h-screen bg-[#f6f7fb] text-slate-900">
            ...
            <div className="flex min-h-screen">
                ...
                <aside
                    className={`fixed left-0 top-0 z-40 flex h-screen w-64 transform flex-col border-r border-slate-200 bg-white px-4 py-5 transition-transform duration-300 lg:static lg:translate-x-0 ${
